...
class General {
    ...
    static courses(value) {
        ...
        // 兼容旧版脚本存储的数据（字段为 sectionName/title 缺失），读取时迁移为 title 字段
        let migrated = false;
        ...
        if (migrated) {
            General.setValue(this.coursesKey, courses);
        }
...
class PlayPage {
    ...
    static createFeedbackBox() {
        ...
        const links = [
            ...
            {title: "GitHub", link: "https://github.com/guohuan78/chinahrt-autoplay"},
				{title: "Issues", link: "https://github.com/guohuan78/chinahrt-autoplay/issues"},
        ];
